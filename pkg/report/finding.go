...
var moduleDisplayKeys = map[string][]string{
	...
	SourceMCP:          {"module", "action", "provider", "transport", "tool_count", "prompt_count", "resource_count", "tools_probed", "server_requests_observed", "auth_enforced", "issuer", "registration_endpoint", "client_id", "server", "config_source", "env_key", "capability", "capability_labels", "confidence", "tool", "prompt", "resource", "endpoint", "mode", "target_alias", "escaped", "escape_technique", "ssti_confirmed", "ssti_signal", "stage", "landed"},
