...
var moduleDisplayKeys = map[string][]string{
	...
	SourceMCP:          {"module", "action", "provider", "transport", "tool_count", "prompt_count", "resource_count", "tools_probed", "sampling_observed", "server", "config_source", "env_key", "capability", "capability_labels", "confidence", "tool", "prompt", "resource", "endpoint", "mode", "target_alias", "escaped", "escape_technique", "ssti_confirmed", "ssti_signal", "stage", "landed"},
