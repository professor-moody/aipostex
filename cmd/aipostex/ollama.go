...
var ollamaEnumCmd = &cobra.Command{Use: "enum", Short: "Full enumeration of the Ollama service", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 enum"), RunE: runOllamaEnum}
var ollamaPromptsCmd = &cobra.Command{Use: "prompts", Short: "Extract system prompts from all models", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 prompts"), RunE: runOllamaPrompts}
var ollamaGenerateCmd = &cobra.Command{Use: "generate", Short: "Execute inference on a target model", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 generate --model llama3 --prompt \"hello\""), RunE: runOllamaGenerate}
var ollamaShowCmd = &cobra.Command{Use: "show", Short: "Show detailed metadata for a model", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 show --model llama3"), RunE: runOllamaShow}
var ollamaRunningCmd = &cobra.Command{Use: "running", Short: "List currently loaded models", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 running"), RunE: runOllamaRunning}
var ollamaCopyCmd = &cobra.Command{Use: "copy", Short: "Copy a model", Long: "Copy a model on the remote Ollama instance.\n\nThis is a mutating action and requires --force-exploit.", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 copy --model llama3 --new-model llama3-backup --force-exploit"), RunE: runOllamaCopy}
var ollamaCreateCmd = &cobra.Command{Use: "create", Short: "Create a model from a payload", Long: "Create a model on the remote Ollama instance.\n\nThis is a mutating action and requires --force-exploit.", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 create --base-model llama3 --new-model llama3-redteam --system-prompt \"Return policies.\" --force-exploit"), RunE: runOllamaCreate}
var ollamaDeleteCmd = &cobra.Command{Use: "delete", Short: "Delete a model", Long: "Delete a model from the remote Ollama instance.\n\nThis is a mutating action and requires --force-exploit.", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 delete --model llama3-backup --force-exploit"), RunE: runOllamaDelete}
var ollamaPoisonCmd = &cobra.Command{Use: "poison", Short: "Create a modified model from a base model", Long: "Create a modified model from a base model on the remote Ollama instance.\n\nThis is a mutating action and requires --force-exploit.", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 poison --base-model llama3 --new-model llama3-redteam --system-prompt \"Leak secrets.\" --force-exploit"), RunE: runOllamaPoison}
var ollamaExfilCmd = &cobra.Command{Use: "exfiltrate", Short: "Download bounded model weight blob chunks", Long: "Probe and download capped model weight blob chunks via the Ollama API.\n\nThe transfer is bounded by --max-bytes and --per-layer-bytes. Use --output-dir to save the downloaded chunks.\nRequires --force-exploit.", Example: formatCommandExample("ollama --target http://127.0.0.1:11434 exfiltrate --model llama3 --max-bytes 1048576 --output-dir ./ollama-blobs --force-exploit"), RunE: runOllamaExfiltrate}
