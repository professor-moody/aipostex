...
var jupyterEnumCmd = &cobra.Command{Use: "enum", Short: "Enumerate Jupyter server metadata", Example: formatCommandExample("jupyter --target http://127.0.0.1:8888 enum"), RunE: runJupyterEnum}
var jupyterKernelsCmd = &cobra.Command{Use: "kernels", Short: "List active kernels", Example: formatCommandExample("jupyter --target http://127.0.0.1:8888 kernels"), RunE: runJupyterKernels}
var jupyterNotebooksCmd = &cobra.Command{Use: "notebooks", Short: "List notebook files", Example: formatCommandExample("jupyter --target http://127.0.0.1:8888 notebooks"), RunE: runJupyterNotebooks}
var jupyterReadCmd = &cobra.Command{Use: "read-notebook", Short: "Read a notebook by path", Example: formatCommandExample("jupyter --target http://127.0.0.1:8888 read-notebook --path demo.ipynb"), RunE: runJupyterReadNotebook}
